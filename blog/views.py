...
class CategoryViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    list: GET /api/categories/?slugs=slug1,slug2 - Filter by specific slugs
...
class SubscribeView(generics.CreateAPIView):
    """
    API endpoint for email subscription (Public - No authentication required)
    
    POST /api/v1/subscribe/ - Add new email subscriber
    """
